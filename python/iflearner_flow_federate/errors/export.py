...
from iflearner_flow_federate.errors.error import IflearnerFlowFederateError
from pytablewriter import MarkdownTableWriter

module_paths = ["iflearner_flow_federate.errors.error"]
...
def get_module_attributes(module_path: str):
    ...
    for class_name, class_ in inspect.getmembers(
        ...
        for attr in attr_list:
            if isinstance(attr[1], IflearnerFlowFederateError):
                module_name = attr[0]
...
def export(dst_file: str):
    errcode_api_md_content = "# Iflearn Flow Federate Errcode API    \n"
